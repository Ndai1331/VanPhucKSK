...
namespace CoreAdminWeb.Services.Contract
{
    ...
    public class ContractService : IBaseService<ContractModel>
    {
        ...
        private const string Fields = "*,user_created.last_name,user_created.first_name,user_updated.last_name,user_updated.first_name"
            ...
            + ",chi_tiet.id,chi_tiet.thanh_tien_tt,chi_tiet.thanh_tien_dm,chi_tiet.chi_phi_thuc_te,chi_tiet.deleted"
            + ",cau_hinh_ho_so_ksk.id,cau_hinh_ho_so_ksk.ngay_du_kien_kham,cau_hinh_ho_so_ksk.ngay_ket_thuc";
        ...
        private static ContractCRUDModel MapToCRUDModel(ContractModel model)
        {
            return new()
            {
                ...
                ngay_nghiem_thu_hd = model.ngay_nghiem_thu_hd,
