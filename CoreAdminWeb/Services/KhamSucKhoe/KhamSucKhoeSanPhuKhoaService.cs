    ...
    public class KhamSucKhoeSanPhuKhoaService : IBaseDetailService<KhamSucKhoeSanPhuKhoaModel>
    {
        ...
        public async Task<RequestHttpResponse<KhamSucKhoeSanPhuKhoaModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                ...
                return response.IsSuccess
                    ? new RequestHttpResponse<KhamSucKhoeSanPhuKhoaModel> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        /// <returns>A <see cref="RequestHttpResponse{T}"/> containing a list of <see cref="KhamSucKhoeSanPhuKhoaModel"/> objects if
        /// the operation is successful. If the request fails, the response contains error details.</returns>
        public async Task<RequestHttpResponse<List<KhamSucKhoeSanPhuKhoaModel>>> CreateAsync(List<dynamic> model)
        {
            if (model == null)
            {
                return new RequestHttpResponse<List<KhamSucKhoeSanPhuKhoaModel>>
            ...
            // Check if all items in model are of type KhamSucKhoeSanPhuKhoaModel
            bool allKhamSucKhoeSanPhuKhoaModel = model.All(item => item is KhamSucKhoeSanPhuKhoaModel);
            if (allKhamSucKhoeSanPhuKhoaModel)
            {
                var typedList = model.Cast<KhamSucKhoeSanPhuKhoaModel>().ToList();
                return await CreateAsync(typedList);
            }

            try
            {
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<List<KhamSucKhoeSanPhuKhoaModel>>>($"items/{_collection}?fields={Fields}", model);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(List<dynamic> model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<KhamSucKhoeSanPhuKhoaModel>>>(
