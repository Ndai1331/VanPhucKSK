...
namespace CoreAdminWeb.Services
{
    ...
    public class KhamSucKhoeCongTyService : IBaseService<KhamSucKhoeCongTyModel>
    {
        ...
        private const string Fields = "*,user_created.last_name,user_created.first_name,user_updated.last_name,user_updated.first_name"
                + ",ma_hop_dong_ksk.id,ma_hop_dong_ksk.code,ma_hop_dong_ksk.name,ma_hop_dong_ksk.status"
                + ",ma_hop_dong_ksk.cong_ty.id,ma_hop_dong_ksk.cong_ty.code,ma_hop_dong_ksk.cong_ty.name"
                + ",bs_tuan_hoan.id,bs_tuan_hoan.first_name,bs_tuan_hoan.last_name,bs_tuan_hoan.chuc_danh"
                + ",bs_ho_hap.id,bs_ho_hap.ma_tai_khoan,bs_ho_hap.first_name,bs_ho_hap.last_name,bs_ho_hap.chuc_danh"
                + ",bs_tieu_hoa.id,bs_tieu_hoa.ma_tai_khoan,bs_tieu_hoa.first_name,bs_tieu_hoa.last_name,bs_tieu_hoa.chuc_danh"
                + ",bs_than_tiet_nieu.id,bs_than_tiet_nieu.ma_tai_khoan,bs_than_tiet_nieu.first_name,bs_than_tiet_nieu.last_name,bs_than_tiet_nieu.chuc_danh"
                + ",bs_noi_tiet.id,bs_noi_tiet.ma_tai_khoan,bs_noi_tiet.first_name,bs_noi_tiet.last_name,bs_noi_tiet.chuc_danh"
                + ",bs_co_xuong_khop.id,bs_co_xuong_khop.ma_tai_khoan,bs_co_xuong_khop.first_name,bs_co_xuong_khop.last_name,bs_co_xuong_khop.chuc_danh"
                + ",bs_than_kinh.id,bs_than_kinh.ma_tai_khoan,bs_than_kinh.first_name,bs_than_kinh.last_name,bs_than_kinh.chuc_danh"
                + ",bs_tam_than.id,bs_tam_than.ma_tai_khoan,bs_tam_than.first_name,bs_tam_than.last_name,bs_tam_than.chuc_danh"
                + ",bs_ngoai_khoa.id,bs_ngoai_khoa.ma_tai_khoan,bs_ngoai_khoa.first_name,bs_ngoai_khoa.last_name,bs_ngoai_khoa.chuc_danh"
                + ",bs_mat.id,bs_mat.ma_tai_khoan,bs_mat.first_name,bs_mat.last_name,bs_mat.chuc_danh"
                + ",bs_tai_mui_hong.id,bs_tai_mui_hong.ma_tai_khoan,bs_tai_mui_hong.first_name,bs_tai_mui_hong.last_name,bs_tai_mui_hong.chuc_danh"
                + ",bs_rang_ham_mat.id,bs_rang_ham_mat.ma_tai_khoan,bs_rang_ham_mat.first_name,bs_rang_ham_mat.last_name,bs_rang_ham_mat.chuc_danh"
                + ",bs_san_phu_khoa.id,bs_san_phu_khoa.ma_tai_khoan,bs_san_phu_khoa.first_name,bs_san_phu_khoa.last_name,bs_san_phu_khoa.chuc_danh"
                + ",bs_ket_luan.id,bs_ket_luan.ma_tai_khoan,bs_ket_luan.first_name,bs_ket_luan.last_name,bs_ket_luan.chuc_danh"
                + ",nguoi_lap_so.id,nguoi_lap_so.ma_tai_khoan,nguoi_lap_so.first_name,nguoi_lap_so.last_name,nguoi_lap_so.chuc_danh";
